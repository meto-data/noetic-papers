...
// @ts-ignore
import focusScript from "./scripts/focusmode.inline"
import styles from "./styles/focusmode.scss"
import { classNames } from "../util/lang"

const FocusMode: QuartzComponent = ({ displayClass }: QuartzComponentProps) => {
  return (
    <button class={classNames(displayClass, "focus-mode-button")} aria-label="Odak modu">
...
FocusMode.afterDOMLoaded = focusScript
